...
def run_mccv_outlier_detection(
    ...
    _, _, X_train_raw = load_data(train_data_dir)
    _, _, X_test_raw = load_data(test_data_dir)
    ...
    for methods in preprocessing_combinations:
        ...
        for col in target_columns:
            ...
            X_valid_raw = X_all_raw[:, spectral_mask].T
            ...
            sample_ids_valid = y_all.loc[sample_mask, 'SampleID'].reset_index(drop=True)
